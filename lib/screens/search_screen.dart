...
import 'package:gap/gap.dart';import '../widgets/double_widget.dart';
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                        "20% discount on the early booking of rhis flight. Don´t miss.",
                   ...
                   children: [
                     Container(
                       ...
                       child: Column(
                         ...
                         children: [
                           Text(
                             "Discount\nfor survev",style: Styles.headLineStyle2.copyWith(fontWeight: FontWeight.bold ,color: Colors.white),),
                           Gap(AppLayout.getHeight(10)),
                           Text(
                             "Take the survery about our services and get discount",style: Styles.headLineStyle2.copyWith(fontWeight: FontWeight.w500 ,color: Colors.white,fontSize: 18),),
                         ],
                       ),
                     ),
                     Positioned(
